...
export const ScoreBreakdown = ({ logs, team }: ScoreBreakdownInterface) => {
    ...
    return (
        <div className="rounded dark:bg-[#302E2E]">
            <Heading className="sticky top-0 z-9 bg-[#302E2E] px-4 py-2">
                Team <span>{team}</span>
            </Heading>
            <div className="flex justify-between border-y dark:border-neutral-600">
                ...
                <div className="flex w-full max-w-60">
                    {
                        +(
                            averages.autoAverage + averages.teleopAverage
                        ).toFixed(1)
                    }
                    <Button
                        variant="none"
                    ...
                    >
                        <Paragraph className="overflow-hidden text-left text-xs font-semibold text-nowrap dark:text-neutral-400">
                            Auto Average
                        </Paragraph>
                        <Paragraph className="text-left font-bold dark:text-white">
                            {+averages.autoAverage.toFixed(1)}{" "}
                    ...
                    >
                        <Paragraph className="overflow-hidden text-left text-xs font-semibold text-nowrap text-ellipsis dark:text-neutral-400">
                            Teleop Average
                        </Paragraph>
                        <Paragraph className="text-left font-bold dark:text-white">
                            {+averages.teleopAverage.toFixed(1)}{" "}
                            <span className="text-xs dark:text-neutral-300">
                                points
                            </span>
                        </Paragraph>
