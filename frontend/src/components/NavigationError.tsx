...
export const NavigationError = () => {
	...
	return (
		<div className="w-full min-h-screen flex items-center justify-center">
			<div className="max-w-xl w-full bg-neutral-100 dark:bg-[#302E2E] h-72 p-4 rounded-sm shadow-md shadow-neutral-300 dark:shadow-neutral-800 flex flex-col items-center">
